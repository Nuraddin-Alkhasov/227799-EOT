...
namespace HMI.CO.Protocol
{
    class NewCharge
    {
        ...
        private int WriteNewCharge(Box box)
        {
            ...
            ChargeNrC.Value = ChargeNr.Value = Charge;
            ...
            new MSSQLEAdapter("Orders", "INSERT " +
                                     ...
                                     box.Id + "," +
                                     Charge + ",'" +
                                     Math.Round((float)Weight.Value, 1).ToString().Replace(",", ".") + "','" +
