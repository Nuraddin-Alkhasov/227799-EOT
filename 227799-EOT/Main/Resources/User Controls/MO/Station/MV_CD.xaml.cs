...
namespace HMI.Resources.UserControls.MO
{
    public partial class MV_CD : UserControl
    {
        public MV_CD()
        {
            ...
            DTTemperature = "CPU1.PLC.Blocks.03 Coating.10 DT.DB DT HMI.Actual.Dipping Vat.Act Paint Temp";
            isDT = "CPU1.PLC.Blocks.03 Coating.10 DT.DB DT HMI.Actual.Dipping Vat.Is Vat";
            PurgeStatus = "CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main HMI.Actual.Exhaust Air.Purge time acitive";
            ViscoCheckL1 = "CPU1.PLC.Blocks.03 Coating.10 DT.DB DT HMI.Actual.Dipping Vat.Viscosity.Check 30 min required";
            ViscoCheckL2 = "CPU1.PLC.Blocks.03 Coating.10 DT.DB DT HMI.Actual.Dipping Vat.Viscosity.Check hard required";
