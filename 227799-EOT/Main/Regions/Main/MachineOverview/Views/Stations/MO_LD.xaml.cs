...
namespace HMI.MainRegion.MO.Views
{
    ...
    public partial class MO_LD 
    {
        ...
        public MO_LD()
        {
            ...
            Release = "CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.PD.Reload.to PC.Release";
            Reloaded = "CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.PD.Reload.to PC.Reloaded";
        }
        ...
        public string Reloaded
        {
            ...
            set
            {
                ...
                {
                    IVReloaded = VS.GetVariable(value);
                    IVReloaded.Change += IVReloaded_ValueChanged;
                }
            }
        }
        private void IVReloaded_ValueChanged(object sender, VariableEventArgs e)
        {
        ...
        private void update_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ApplicationService.SetVariableValue("CPU1.PLC.Blocks.01 Basket feeding.01 LD.00 Main.DB LD HMI.PC.PD.Reload.from PC.Reload", true);
            }
