        ...
        public Coating Coating
        {
            set
            {
                ...
                if (coating != null)
                {
                    ...
                    {
                        VWVariable aa = value.VWRecipe.VWVariables.First(x => x.Item.ToString() == "CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[0].Dipping.Vat identifier");
