...
namespace HMI.Resources.UserControls
{
    public partial class CoatingStep2 : UserControl
    {
        public CoatingStep2()
        {
            ...
            InitializeComponent();
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Type", 2);
        }
        ...
        private void Astraight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Dip Time", 0);
        ...
        private void A50_Click(object sender, RoutedEventArgs e)
        {
            ...
            border1.Visibility = Visibility.Collapsed;
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Time Straight", 0);
        ...
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Angle", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Change of Direction", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Dip Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Draining Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Rotation Speed", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Straight Before", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Time Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Dipping.Vat identifier", 0);
        }
        private void ResetSpinning()
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.1.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.1.Rotor Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.2.Planet RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.2.Planet Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.2.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.3.Rotor RPM", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Coating.00 Main.DB Coating Main PD Buffer.CoatingStep[1].Spinning.3.Rotor Time", 0);
        }
        #endregion
