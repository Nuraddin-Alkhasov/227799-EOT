...
namespace HMI.MainRegion.Recipes.Adapters
{
    ...
    public class Recipes_Article : AdapterBase
    {
        ...
        public Recipes_Article()
        {
            ...
            POUnload = new ActionCommand(POUnloadExecuted);
        }
        ...
        {
            Content = new Recipe_Article_POReturn();
        }
        public ICommand POUnload { get; set; }
        private void POUnloadExecuted(object parameter)
        {
            Content = new Recipe_Article_POUnload();
        }
